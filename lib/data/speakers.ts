...
export const SPEAKERS_DATA: SpeakerTopic[] = [
  {
    ...
    speakers: [
      ...
      },
      {
        ...
        company: { 'zh-tw': "薩泰爾娛樂", 'en': "STR Network Entertainment" },
        topic: { 'zh-tw': "一間喜劇公司怎麼用 DDD？", 'en': "How does a comedy company use DDD?" },
        content: { 'zh-tw': "DDD導入歷程", 'en': "DDD Implementation Journey" },
        bio: { 'zh-tw': "薩泰爾娛樂共同創辦人，撰寫電子報《無用之用 Master of None》在 AI 浪潮下持續探索組織、科技與人性交會的各種可能。", 'en': "Co-founder of STR Network Entertainment, author of the newsletter 'Master of None', continuously exploring the intersection of organization, technology, and humanity in the AI wave." },
